        ...
        <div className="mb-5">
          <div className="project-paragraph">
            ...
            <p>
              ...
              json objects where it then adds them as events to your calendar.
            </p>
          </div>
          <div className="project-paragraph">
            ...
            <p>
              ...
              Express to implement a RESTful API. It seamlessly configures OAuth
              2.0 to authenticate the user, then takes advantage of the Google
              Gemini LLM to parse emails for events. Caching is also implemented
              to reduce API calls.
            </p>
          </div>
          <div className="project-paragraph">
