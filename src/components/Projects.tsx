      ...
      <div className="section-container">
        ...
        <div className="column-section">
          <div className="projects-container">
            <Project
              title={"HubSpot Internship Project"}
              image={""}
              date={"2025"}
              tags={["Java", "CI/CD Pipelines", "E2E Testing"]}
              caption={
                "Developed Java RPC microservices to validate user permissions in end-to-end tests, processing 1M+ tests daily."
              }
              githubLink={""}
              viewMoreLink={""}
            />
            <Project
              ...
              viewMoreLink={"https://github.com/juliewang617/Bearly-Used"}
            />
            {/* <Project
